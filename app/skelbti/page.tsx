...
export default function CreateJobPage() {
  ...
  if (done) return <><Navigation /><main className="success-page"><div className="success-card"><div className="success-mark">✓</div><h1>Skelbimo forma paruošta</h1><p>Ši demonstracinė forma patikrinta frontend lygmenyje. Skelbimas nebuvo išsaugotas ar publikuotas, nes tam reikia backend ir prisijungusio darbdavio.</p><div className="success-actions"><Link href="/" className="btn btn-primary">Į pagrindinį</Link><Link href="/skelbimai" className="btn btn-secondary">Peržiūrėti skelbimus</Link></div></div></main><Footer /></>;

  return (
    <><Navigation /><main className="registration-page"><div className="registration-wrap narrow"><form className="registration-card" onSubmit={submit}><div className="form-heading"><span className="eyebrow">Darbdavio įrankis</span><h1>Sukurti darbo pasiūlymą</h1><p>Forma paruošta būsimam duomenų išsaugojimui. Skelbimų talpinimas planuojamas nemokamas.</p></div><div className="notice notice-info"><strong>Demonstracinis režimas</strong><span>Kol nėra autentifikacijos, šį puslapį galima peržiūrėti, bet pateiktas skelbimas niekur neišsaugomas.</span></div><div className="form-stack">
